...
<div class="row">
    <div class="col-md-2 my-4">
        <div class="card">
            <div class="card-body">
                <a href="{{ route('fornecedores.create') }}" type="submit" class="btn btn-success w-100">
                    <i class="bi bi-plus"></i> Novo
                </a>
                <hr class="my-3">
                <div class="form-group">
                    <label class="pb-1">Buscar:</label>
                    <form action="{{ route('fornecedores.index') }}" method="GET" autocomplete="off">
    ...
    <div class="col-md-10 my-4">
        <div class="card">
            ...
            <div class="card-body p-2">
                ...
                <div class="d-flex justify-content-center min-pagination-height">{!! $fornecedores->links() !!}</div>
            </div>
