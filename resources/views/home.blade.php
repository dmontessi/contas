...
<div class="row">
    ...
    <div class="d-flex flex-column my-4">
        ...
        {{-- <div class="d-flex justify-content-center mb-2">
            <small class="d-inline-flex px-2 py-1 fw-semibold text-primary bg-primary-subtle border border-primary-subtle rounded-2">
                <span>{{ ucfirst(\Carbon\Carbon::now()->locale('pt-BR')->isoFormat('MMMM [de] YYYY')) }}
        </small>
    </div> --}}
